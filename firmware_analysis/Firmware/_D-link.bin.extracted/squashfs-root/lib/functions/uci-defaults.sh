...
set network.wan.macclone='0'
set network.wan.pppoetype='normal'
set network.wan.pppoestatus='100'
#set network.wan6='interface'
#set network.wan6.ifname='@wan'
#set network.wan6.proto='dhcpv6'
set network.wan.speed_duplex='Auto Auto'
EOF
}
...
set network.guest.ipaddr='192.168.7.1'
