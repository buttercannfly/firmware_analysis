...
$(document).ready( function() {
  ...
  $('#liworkmode').addClass("submenucurent");
   break;
...
function LeftMenuForRouter() {
 ...
 a+="<li id='liworkmode'><a  href='javascript:void(0);' onclick='LeftMenuClickOn(\"WorkMode\");' id='lang_workmode'>工作模式</a></li>";
 a+="</ul>";
 ...
 a+="<li id='liportforward'><a href='javascript:void(0);'  onclick='LeftMenuClickOn(\"PortForward\");' id='lang_portforward'>"+I18N("j","Commom_Virtual_Server")+"</a></li>";
